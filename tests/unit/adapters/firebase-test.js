...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | generateIdForRecord', {
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | createRecord', {
  needs: ['service:firebase'],
...
test('should update Firebase', async function(assert) {
  ...
  // Assert
  assert.ok(setSpy.calledWithExactly('_innerPath', 'bar/dee'));
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | updateRecord', {
  needs: ['service:firebase'],
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | findRecord', {
  needs: ['service:firebase'],
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | findAll', {
  needs: ['service:firebase'],
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | deleteRecord', {
  needs: ['service:firebase'],
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | queryRecord', {
  needs: ['service:firebase'],
...
moduleFor('adapter:firebase', 'Unit | Adapter | firebase | query', {
  needs: ['service:firebase'],
